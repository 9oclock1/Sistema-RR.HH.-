...
-- NOTA: no incluyas CREATE DATABASE ni \c aquí.
-- init-all.sh ya crea "EmployeeDB" y corre este archivo
-- directo contra esa base con: psql --dbname "EmployeeDB" -f init.sql
